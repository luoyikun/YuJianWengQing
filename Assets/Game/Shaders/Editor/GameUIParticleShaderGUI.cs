...
/// </summary>
public class GameUIParticleShaderGUI : NirvanaShaderGUI
{
        ...
        MaterialEditor materialEditor, Material[] materials)
    {
        ...
        /*materialEditor.FloatProperty(this.offsetFactor, "Offset Factor");
        materialEditor.FloatProperty(this.offsetUnits, "Offset Unit");*/
    }
