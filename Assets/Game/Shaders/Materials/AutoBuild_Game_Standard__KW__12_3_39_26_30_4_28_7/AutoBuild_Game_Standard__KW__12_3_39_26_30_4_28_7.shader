...
Shader "AutoBuild/Game/Standard__KW__12_3_39_26_30_4_28_7"
{
    Properties
    {
        // Rendering mode.
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature _ _ALPHA_BLEND _ALPHA_PREMULTIPLY
...
#   if !defined(_ALPHA_BLEND) && !defined(_ALPHA_PREMULTIPLY) && !defined(ALPHA_IS_METALLIC)
...
#   endif
        ...
        Pass
        {
            ...
            #pragma shader_feature _ ENABLE_SEPCULAR
