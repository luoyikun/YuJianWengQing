...
function SCRoleListAck:Decode()
	...
	for i = 1, self.count do
		...
		self.role_list[i].shizhuang_wuqi_is_special = MsgAdapter.ReadChar()
		self.role_list[i].shizhuang_body = MsgAdapter.ReadChar()
		self.role_list[i].shizhuang_body_is_special = MsgAdapter.ReadChar()
		self.role_list[i].wing_used_imageid = MsgAdapter.ReadShort()
		self.role_list[i].halo_used_imageid = MsgAdapter.ReadShort()
		self.role_list[i].yaoshi_used_imageid = MsgAdapter.ReadShort()
		self.role_list[i].toushi_used_imageid = MsgAdapter.ReadShort()
		self.role_list[i].qilinbi_used_imageid = MsgAdapter.ReadShort()
		self.role_list[i].mask_used_imageid = MsgAdapter.ReadShort()
		self.role_list[i].lingzhu_used_imageid = MsgAdapter.ReadShort()
		self.role_list[i].xianbao_used_imageid = MsgAdapter.ReadShort()
		self.role_list[i].lingtong_used_imageid = MsgAdapter.ReadShort()
		self.role_list[i].linggong_used_imageid = MsgAdapter.ReadShort()
		self.role_list[i].lingqi_used_imageid = MsgAdapter.ReadShort()
		self.role_list[i].weiyan_used_imageid = MsgAdapter.ReadShort()
		self.role_list[i].shouhuan_used_imageid = MsgAdapter.ReadShort()
		self.role_list[i].tail_used_imageid = MsgAdapter.ReadShort()
		self.role_list[i].flypet_used_imageid = MsgAdapter.ReadShort()
	end
end
...
function SCMergeRoleListAck:Decode()
	...
	for i = 1, self.count do
		...
		role_item.shizhuang_wuqi_is_special = MsgAdapter.ReadChar() 		-- 时装武器是特殊形象
		role_item.shizhuang_body = MsgAdapter.ReadChar()
		role_item.shizhuang_body_is_special = MsgAdapter.ReadChar()			-- 时装身体是特殊形象
		...
		role_item.lingzhu_used_imageid = MsgAdapter.ReadShort()
		role_item.xianbao_used_imageid = MsgAdapter.ReadShort()
		role_item.lingtong_used_imageid = MsgAdapter.ReadShort()
		role_item.linggong_used_imageid = MsgAdapter.ReadShort()
		role_item.lingqi_used_imageid = MsgAdapter.ReadShort()
		role_item.weiyan_used_imageid = MsgAdapter.ReadShort()
		role_item.shouhuan_used_imageid = MsgAdapter.ReadShort()
		role_item.tail_used_imageid = MsgAdapter.ReadShort()
		role_item.flypet_used_imageid = MsgAdapter.ReadShort()
