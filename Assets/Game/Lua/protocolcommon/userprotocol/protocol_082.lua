...
-- 卸下装备
CSChineseZodiacTakeOffEquip = CSChineseZodiacTakeOffEquip or BaseClass(BaseProtocolStruct)
function CSChineseZodiacTakeOffEquip:__init()
	self.msg_type = 8213
end

function CSChineseZodiacTakeOffEquip:Encode()
	MsgAdapter.WriteBegin(self.msg_type)
	MsgAdapter.WriteShort(self.zodiac_type)
	MsgAdapter.WriteShort(self.equip_type)
end

-- 生肖装备回收
CSChineseZodiacRecycle = CSChineseZodiacRecycle or BaseClass(BaseProtocolStruct)
function CSChineseZodiacRecycle:__init()
	self.msg_type = 8214
	self.index_list = {}
end

function CSChineseZodiacRecycle:Encode()
	MsgAdapter.WriteBegin(self.msg_type)
