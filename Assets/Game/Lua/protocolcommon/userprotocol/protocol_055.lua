...
function SCExpFbInfo:Decode()
	...
	self.record_max_exp = MsgAdapter.ReadLL()
	self.exp_percent = MsgAdapter.ReadInt()
...
function CSExpFbPayGuwu:Encode()
	...
	MsgAdapter.WriteShort(self.reverse_sh)
end
