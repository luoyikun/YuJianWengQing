...
function SCFriendInfoAck:Decode()
	...
	for i = 1, self.count do
		...
		self.friend_list[i].group_name = MsgAdapter.ReadStrN(32)
		...
		self.friend_list[i].favorable_impression = MsgAdapter.ReadInt()
		self.friend_list[i].day_chat_count = MsgAdapter.ReadInt()
		self.friend_list[i].add_timestamp = MsgAdapter.ReadUInt()			-- 添加好友时间戳
	end
end
...
function SCChangeFriend:Decode()
	...
	self.friend_info.favorable_impression = MsgAdapter.ReadInt()
	self.friend_info.day_chat_count = MsgAdapter.ReadInt()
	self.friend_info.add_timestamp = MsgAdapter.ReadUInt()			-- 添加好友时间戳
end
...
function StructEnemy.ReadEnemyItem()
	...
	stu.plat_type = MsgAdapter.ReadInt()
	stu.user_id = MsgAdapter.ReadInt()
	stu.kill_count = MsgAdapter.ReadInt()
	stu.be_kill_count = MsgAdapter.ReadInt()
...
function SCEnemyListACK:Decode()
	...
	for i = 1, self.count do
		self.enemy_list[i] = {}
		self.enemy_list[i].last_kill_time = MsgAdapter.ReadLL()
		self.enemy_list[i].user_id = MsgAdapter.ReadInt()
		self.enemy_list[i].plat_type = MsgAdapter.ReadInt()
		self.enemy_list[i].kill_count = MsgAdapter.ReadInt()
		self.enemy_list[i].be_kill_count = MsgAdapter.ReadInt()
		self.enemy_list[i].index = MsgAdapter.ReadInt()
		self.enemy_list[i].is_online = 0
	end
end
...
function SCChangeEnemy:Decode()
	...
	self.enemy_info.plat_type = MsgAdapter.ReadInt()
	self.enemy_info.last_kill_time = MsgAdapter.ReadLL()
	self.enemy_info.kill_count = MsgAdapter.ReadInt()
	self.enemy_info.be_kill_count = MsgAdapter.ReadInt()
	self.changestate = MsgAdapter.ReadShort()
	MsgAdapter.ReadShort()
end
