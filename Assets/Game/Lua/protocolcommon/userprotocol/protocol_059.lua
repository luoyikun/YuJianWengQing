...
function SCTerritoryWarGlobeInfo:Decode()
	...
	self.red_fortress_max_hp = MsgAdapter.ReadLL()
	self.red_fortress_curr_hp = MsgAdapter.ReadLL()
	self.blue_fortress_max_hp = MsgAdapter.ReadLL()
	self.blue_fortress_curr_hp = MsgAdapter.ReadLL()
	self.center_relive_max_hp = MsgAdapter.ReadLL()
	self.center_relive_curr_hp = MsgAdapter.ReadLL()
...
function SCFightingResultNotify:Decode()
	...
	self.is_skip = MsgAdapter.ReadShort()
