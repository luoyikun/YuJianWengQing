...
function ProtocolStruct.ReadRoleAppearance()
	...
	t.fashion_wuqi_is_special =  MsgAdapter.ReadChar()
	t.fashion_body = MsgAdapter.ReadChar()
	t.fashion_body_is_special = MsgAdapter.ReadChar()
	...
	t.fabao_used_imageid = MsgAdapter.ReadShort()
	MsgAdapter.ReadShort()
	t.yaoshi_used_imageid  = MsgAdapter.ReadShort()
	t.toushi_used_imageid = MsgAdapter.ReadShort()
	t.qilinbi_used_imageid = MsgAdapter.ReadShort()
	t.mask_used_imageid = MsgAdapter.ReadShort()
	MsgAdapter.ReadShort()
	t.lingzhu_used_imageid = MsgAdapter.ReadShort()
	t.xianbao_used_imageid = MsgAdapter.ReadShort()
	t.lingchong_used_imageid = MsgAdapter.ReadShort()
	t.linggong_used_imageid = MsgAdapter.ReadShort()
	t.lingqi_used_imageid = MsgAdapter.ReadShort()
	t.weiyan_used_imageid = MsgAdapter.ReadShort()
	t.shouhuan_used_imageid = MsgAdapter.ReadShort()
	t.tail_used_imageid = MsgAdapter.ReadShort()
	t.flypet_used_imageid = MsgAdapter.ReadShort()
...
function ProtocolStruct.ReadItemParamData()
	...
	t.xianpin_equip = MsgAdapter.ReadShort()
	...
	for i = 0, GameEnum.JING_LING_SKILL_COUNT_MAX - 1 do
		...
		skill_t.is_slot_open = MsgAdapter.ReadChar()
		t.jing_ling_skill_list[i] = skill_t
	end

	t.really = MsgAdapter.ReadUShort()
	t.xianpin_star_num = MsgAdapter.ReadUShort()
