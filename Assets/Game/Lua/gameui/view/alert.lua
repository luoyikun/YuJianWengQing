...
function Alert:LoadCallBack()
	self.title_txt = self:FindObjByPath("PackUpTips/Text_Title")
	self.content_txt = self:FindObjByPath("PackUpTips/TipsText")

	local ok_btn = self:FindObjByPath("PackUpTips/YesButton")
	ok_btn.button:AddClickListener(BindTool.Bind(self.OnClickOkBtn, self))
	self.ok_btn_text = self:FindObjByPath("PackUpTips/YesButton/YesText")

	local cancel_btn = self:FindObjByPath("PackUpTips/NoButton")
	cancel_btn.button:AddClickListener(BindTool.Bind(self.OnClickCancelBtn, self))
	self.cancel_btn_text = self:FindObjByPath("PackUpTips/NoButton/NoText")

	self.close_btn = self:FindObjByPath("PackUpTips/CloseButton")
	self.close_btn.button:AddClickListener(BindTool.Bind(self.OnClickCloseBtn, self))

	local bg_btn = self:FindObjByPath("BGButton")
