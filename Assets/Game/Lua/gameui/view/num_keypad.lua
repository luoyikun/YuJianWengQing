...
function NumKeypad:LoadCallBack()
	local bg = self:FindObjByPath("BGButton")
	bg.button:AddClickListener(BindTool.Bind(self.HandleClickClose, self))
	local close_btn = self:FindObjByPath("ComputerTips/CloseBtn")
	close_btn.button:AddClickListener(BindTool.Bind(self.HandleClickClose, self))

	self.input_num_txt = self:FindObjByPath("ComputerTips/ManyBG/Many")
	self.key0 = self:FindObjByPath("ComputerTips/BtnObj/Btn8")
	self.key1 = self:FindObjByPath("ComputerTips/BtnObj/Btn1")
	self.key2 = self:FindObjByPath("ComputerTips/BtnObj/Btn2")
	self.key3 = self:FindObjByPath("ComputerTips/BtnObj/Btn3")
	self.key4 = self:FindObjByPath("ComputerTips/BtnObj/Btn5")
	self.key5 = self:FindObjByPath("ComputerTips/BtnObj/Btn6")
	self.key6 = self:FindObjByPath("ComputerTips/BtnObj/Btn7")
	self.key7 = self:FindObjByPath("ComputerTips/BtnObj/Btn9")
	self.key8 = self:FindObjByPath("ComputerTips/BtnObj/Btn10")
	self.key9 = self:FindObjByPath("ComputerTips/BtnObj/Btn11")
	self.del_btn = self:FindObjByPath("ComputerTips/BtnObj/Btn4")
	self.ok_btn = self:FindObjByPath("ComputerTips/BtnObj/Btn12")
...
function NumKeypad:FindObjByPath(name_path)
