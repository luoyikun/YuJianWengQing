...
function MultiMountCtrl:__init()
	...
	self.multi_mount_huan_hua_view = MultiMountHuanHuaView.New(ViewName.MultiMountHuanHua)
...
function MultiMountCtrl:__delete()
	...
	if nil ~= self.multi_mount_huan_hua_view then
		self.multi_mount_huan_hua_view:DeleteMe()
		self.multi_mount_huan_hua_view = nil
	end
...
function MultiMountCtrl:OnSCMultiMountChangeNotify(protocol)
	...
	if self.multi_mount_huan_hua_view and self.multi_mount_huan_hua_view:IsOpen() then
		self.multi_mount_huan_hua_view:Flush()
	end
