...
ObjectEventType =
{
	...
	VIP_CHANGE = "vip_change",											-- vip改变(旧vip只是临时存储本次登录时的vip等级, 不做本地存储)
}
...
MainUIEventType =
{
	...
	SHOW_OR_HIDE_IMAGESKILL_BUTTON = "show_or_hide_imageskill_button",			-- 显示或隐藏形象秒杀按钮
...
SettingEventType = {
	...
	SHIELD_LINGCHONG = "shield_lingchong",								-- 屏蔽灵童
	SHIELD_FLYPET = "shield_flypet",									-- 屏蔽飞宠
	SHIELD_ADVANCE = "shield_advance",									-- 屏蔽形象
	...
	AUTO_MOJIE_SKILL = "auto_mojie_skill",								-- 自动释放特戒技能
	AUTO_USE_FLY_SHOE = "auto_use_fly_shoe",							-- 自动使用小飞鞋
	AUTO_USE_SKILL = "auto_use_skill",									-- 自动释放技能
	AUTO_USE_SHENMO = "auto_use_shenmo",								-- 自动变身
	AUTO_USE_HIGH_FPS = "auto_use_high_fps",							-- 使用高帧率
...
OtherEventType = {
	...
	FLUSH_ELEMENT_BAG_GRID = "flush_element_bag_grid",					-- 刷新元素元装背包面板
	...
	ACTIVITY_STATUS = "activity_status",								-- 活动信息下发
}
...
OpenFunEventType = {
	...
	OPEN_PAUSE = "open_pause",											-- 功能开启中暂停状态
}
...
ChatEventType = {
	...
	KF_LABA = "kf_laba",												-- 跨服喇叭
}

-- 场景中聊天事件
SceneChatEventType = {
	NPC_GROUP_CHAT = "NPC_GROUP_CHAT",									-- NPC群聊通知主角
}

AuditEvent = {
	ROLE_CHANGE = "role_change",										--人物数据改变
	RECHARGE_CHANGE = "recharge_change",								--充值改变
}
