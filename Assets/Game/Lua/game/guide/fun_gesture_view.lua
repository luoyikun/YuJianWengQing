...
function FunGestureView:LoadCallBack()
	local listener = self.node_list["Background"].event_trigger_listener
	listener:AddPointerDownListener(BindTool.Bind(self.TouchBegin, self))
	listener:AddPointerUpListener(BindTool.Bind(self.TouchEnd, self))
end
