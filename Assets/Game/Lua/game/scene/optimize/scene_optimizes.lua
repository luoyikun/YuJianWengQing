...
require("game/scene/optimize/lingchong_shield_optimize")
require("game/scene/optimize/flypet_shield_optimize")
...
function SceneOptimize:__init()
	...
	self.optimize_list = {
		...
		LingChongShieldOptimize.New(),
		FlyPetShieldOptimize.New(),
	}
