...
function IncreaseCapabilityData:__init()
	...
	RemindManager.Instance:Register(RemindName.IncreaseCapability, BindTool.Bind(self.GetIncreaseCapabilityRemind, self))
...
function IncreaseCapabilityData:__delete()
	RemindManager.Instance:UnRegister(RemindName.IncreaseCapability)
...
function IncreaseCapabilityData:GetIncreaseCapabilityRemind()
	if RemindManager.Instance:RemindToday(RemindName.IncreaseCapability) then
		return 0
	else
		return 1
	end
