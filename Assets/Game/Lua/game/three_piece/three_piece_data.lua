...
function ThreePieceData:SetChargeInfo(info)
	...
	self.rechange_info.cur_consume_reward = info.cur_consume_reward
	self.rechange_info.ra_total_has_flag = info.ra_total_charge_4_cur_has_fetch_flag
