...
function CheckCtrl:OnGetRoleBaseInfoAck(protocol)
	...
	GuildData.Instance:SaveTuanzhangInfo(protocol.role_id, protocol)
	...
	CrossRankCtrl.Instance:OnGetRoleBaseInfoAck()
	-- 三界霸主人物信息
	ActivityData.Instance:SaveFirstRankRoleInfo(protocol.role_id, protocol)
...
-- 给赞
function CheckCtrl:SendEvaluateRoleReq(target_uid, callback)
...
function CheckCtrl:BanZhanChange(flag)
