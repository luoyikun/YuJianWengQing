...
function ReincarnationData:GetForceByLevel(maxhp,gongji,fangyu)
...
function ReincarnationData:GetConfig()
	for k,v in pairs(self.zhuansheng) do
		if v.zhuansheng_level == self:GetZsLevel() then
			return v
		end
	end
	return self.zhuansheng[1]
end
