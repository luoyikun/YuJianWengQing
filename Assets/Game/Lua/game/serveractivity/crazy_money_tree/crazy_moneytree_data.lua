...
function CrazyMoneyTreeData:GetIsFirstEnter()
	return self.is_first_enter
end

function CrazyMoneyTreeData:SetIsFirstEnter(is_first_enter)
	self.is_first_enter = is_first_enter
end

function CrazyMoneyTreeData:CalNeedShowMainIcon()
	return self:CanGetGole() or self.is_first_enter
end

function CrazyMoneyTreeData:CanGetGole()
	local gold_num = self.total_chongzhi_gold - self.chongzhi_gold
	return gold_num > 0
end
