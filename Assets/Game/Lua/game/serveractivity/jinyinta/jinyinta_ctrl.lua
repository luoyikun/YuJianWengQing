...
function JinYinTaCtrl:__init()
	...
	RemindManager.Instance:Bind(self.remind_change, RemindName.JINYINTA)
end
...
function JinYinTaCtrl:RemindChangeCallBack(remind_name, num)
	if remind_name == RemindName.JINYINTA then
