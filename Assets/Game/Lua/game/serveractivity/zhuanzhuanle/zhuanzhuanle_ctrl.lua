...
function ZhuanZhuanLeCtrl:__init()
	...
	RemindManager.Instance:Bind(self.remind_change, RemindName.ZHUANZHUANLE)
end
...
function ZhuanZhuanLeCtrl:RemindChangeCallBack(remind_name, num)
	if remind_name == RemindName.ZHUANZHUANLE then
