...
function WorldQuestionData:__init()
	...
	self.is_send_answer_reqest = true
	self.answer_list = {}
	...
	self.cur_world_question_index = 1
	self.cur_guild_question_index = 1
...
function WorldQuestionData:SetSendAnswerReq(enable)
	self.is_send_answer_reqest = enable
end

function WorldQuestionData:GetSendAnswerReq()
	return self.is_send_answer_reqest
end
