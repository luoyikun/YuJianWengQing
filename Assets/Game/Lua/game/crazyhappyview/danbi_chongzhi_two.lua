DanBiChongZhiTwo = DanBiChongZhiTwo or BaseClass(BaseRender)
--单笔充值
function DanBiChongZhiTwo:__init()
	self.contain_cell_list = {}
	self.reward_list = {}
end

function DanBiChongZhiTwo:__delete()
...
function DanBiChongZhiTwo:OpenCallBack()
	local list_delegate = self.node_list["ScrollerListView"].list_simple_delegate
	list_delegate.NumberOfCellsDel = BindTool.Bind(self.GetNumberOfCells, self)
	list_delegate.CellRefreshDel = BindTool.Bind(self.RefreshCell, self)

	local rest_time, next_time = ActivityData.Instance:GetActivityResidueTime(ACTIVITY_TYPE.RAND_ACTIVITY_TYPE_DANBICHONGZHITWO)
	-- local opengameday = TimeCtrl.Instance:GetCurOpenServerDay()
	self.reward_list = CrazyHappyData.Instance:GetSingleChargeInfoTwo(ACTIVITY_TYPE.RAND_ACTIVITY_TYPE_DANBICHONGZHITWO)
...
function DanBiChongZhiTwo:CloseCallBack()
	if self.least_time_timer then
		CountDown.Instance:RemoveCountDown(self.least_time_timer)
		self.least_time_timer = nil
	end
...
function DanBiChongZhiTwo:ClickReChange()
	VipData.Instance:SetOpenType(OPEN_VIP_RECHARGE_TYPE.RECHANRGE)
	ViewManager.Instance:Open(ViewName.VipView)
end

function DanBiChongZhiTwo:GetNumberOfCells()
	return #self.reward_list
end

function DanBiChongZhiTwo:RefreshCell(cell, cell_index)
	local contain_cell = self.contain_cell_list[cell]
	
	if contain_cell == nil then
		contain_cell = DanBiChongZhiTwoCell.New(cell.gameObject, self)
...
function DanBiChongZhiTwo:SetTime(rest_time)
...
function DanBiChongZhiTwo:OnFlush()
...
------------------------------DanBiChongZhiTwoCell-------------------------------------
DanBiChongZhiTwoCell = DanBiChongZhiTwoCell or BaseClass(BaseCell)

local MAX_CELL_NUM = 4

function DanBiChongZhiTwoCell:__init()
	self.charge_value = 0
	self.item_cell_list = {}
...
function DanBiChongZhiTwoCell:__delete()
...
function DanBiChongZhiTwoCell:SetChargeValue(value)
	self.charge_value = value
end

function DanBiChongZhiTwoCell:OnFlush()
...
function DanBiChongZhiTwoCell:OnClickGet()
	VipData.Instance:SetOpenType(OPEN_VIP_RECHARGE_TYPE.RECHANRGE)
	ViewManager.Instance:Open(ViewName.VipView)
end