...
function AStarFindWay:FindWay(start_pos, end_pos, ignore_high_area)
	return GridFindWay:FindWay(start_pos.x, start_pos.y, end_pos.x, end_pos.y, ignore_high_area)
...
-- 是否阻挡区域
function AStarFindWay:IsBlock(x, y, ignore_high_area)
	return GridFindWay:IsBlock(x, y, ignore_high_area)
...
function AStarFindWay:GetLineEndXY(x, y, end_x, end_y, ignore_high_area)
	return GridFindWay:GetLineEndXY(x, y, end_x, end_y, nil, nil, ignore_high_area)
...
function AStarFindWay:GetLineEndXY2(x, y, end_x, end_y, ignore_high_area)
	return GridFindWay:GetLineEndXY2(x, y, end_x, end_y, nil, nil, ignore_high_area)
...
-- 是否可直线通行
function AStarFindWay:IsWayLine(x, y, end_x, end_y, ignore_high_area)
	return GridFindWay:IsWayLine(x, y, end_x, end_y, ignore_high_area)
...
-- cell_type参数用来设置禁止行走但允许寻路之类的情况 2可以默认不允许走 但可以寻路过去
function AStarFindWay:SetBlockInfo(x, y, cell_type)
	cell_type = cell_type or 0
	GridFindWay:SetBlock(x, y, cell_type)
end
...
-- 检测格子类型是否相等(此方法适用所有类型)
function AStarFindWay:GetCellTypeIsSame(x, y, cell_type)
	return GridFindWay:GetCellTypeIsSame(x, y, cell_type)
end
