...
public class CameraShake : MonoBehaviour
{
    ...
    {
        var duration = numberOfShakes * Mathf.Max(Mathf.PI * 2 / speed, 1 / 30f);
        duration = Mathf.Max(Mathf.RoundToInt(duration * 1000) / 1000f, 0.1f);
        speed = Mathf.Max(Mathf.PI * 2 / (duration / numberOfShakes), 0.1f);
